...
export const TasksStateRecord = Record({
    tasks: List([
        ...
        new Task({ id: 3, name: 'Buy dog food', description: 'Not the red pill', status: Status.OPEN }),
        ...
        new Task({ id: 6, name: 'Cash my paycheck', description: 'Not the red pill', status: Status.IN_PROGRESS }),
    ]),
});
